...
const SslcommerzPayment = ({ navigation, route }) => {

  const newData = {
    amount: route.params.amount,
    customer_name: route.params.customer_name,
    customer_email: route.params.customer_email,
    customer_address: "comilla",
    customer_phone: route.params.customer_phone,
    customer_city: "Comilla",
  };
      ...
      <WebView
        ...
        onNavigationStateChange={(event) => {
          ...
          if (event.url.includes("paymentapp://Success")) {
            ...
            navigationn.navigate("Success"); // Navigate to the Success screen
