...
function BmiTracker({ navigation, route }) {
  ...
  const monthWiseData = processBmiData(bmi);
      ...
      <View style={styles.MainContainer}>
        ...
        <View style={[styles.navbar, { flexDirection: 'row' }]}>
          ...
          <View style={{ width: '50%', justifyContent: 'flex-start', alignItems: 'flex-start', left: 10 }}>
            ...
            <Text style={{ left: 10, top: 17, color: colors.black, fontSize: 14, display: lan ? 'flex' : 'none', letterSpacing: .9, fontFamily: 'Poppins_400Regular' }} >  BMI Tracker </Text>
          ...
          <ScrollView style={{ width: "100%" }} >
            ...
            <View style={{ width: '100%', justifyContent: 'center', alignItems: 'center', marginTop: 40, paddingHorizontal: 10 }}>
              ...
              <View style={styles.tableContainer}>
                <Text style={styles.tableTitle}>Your BMI History</Text>
                <View style={styles.table}>
                  <View style={styles.tableRow}>
                    <Text style={styles.tableHeading}>Month</Text>
                    <Text style={styles.tableHeading}>Date</Text>
                    <Text style={styles.tableHeading}>Your BMI</Text>
                  </View>
            ...
            <View style={{ width: '100%', justifyContent: 'center', alignItems: 'center', marginTop: 40, paddingHorizontal: 10 }}>
              ...
              <View style={styles.tableContainer}>
                <Text style={styles.tableTitle}>BMI Categories and Health Implications</Text>
                <View style={styles.table}>
                  <View style={styles.tableRow}>
                    <Text style={styles.tableHeading}>BMI Category</Text>
                    <Text style={styles.tableHeading}>BMI Category</Text>
                    <Text style={styles.tableHeading}>Health Interpretation</Text>
                  </View>

                  <View style={styles.tableRow}>
                    <Text style={styles.tableCell}>Underweight</Text>
                    <Text style={styles.tableCell}>{"<"} 18.5</Text>
                    <Text style={styles.tableCell}>Below normal weight</Text>
                  </View>
                  ...
                  <View style={styles.tableRow}>
                    ...
                    <Text style={styles.tableCell}>Healthy weight</Text>
                  </View>
                  ...
                  <View style={styles.tableRow}>
                    ...
                    <Text style={styles.tableCell}>At risk of health issues</Text>
                  </View>


                  <View style={styles.tableRow}>
                    <Text style={styles.tableCell}>Obesity (Class 1)</Text>
                    <Text style={styles.tableCell}>30 - 34.9</Text>
                    <Text style={styles.tableCell}>Increased health risks</Text>
                  </View>


                  <View style={styles.tableRow}>
                    <Text style={styles.tableCell}>Obesity (Class 2)</Text>
                    <Text style={styles.tableCell}>35 - 39.9</Text>
                    <Text style={styles.tableCell}>High health risks</Text>
                  </View>


                  <View style={styles.tableRow}>
                    <Text style={styles.tableCell}>Extreme Obesity</Text>
                    <Text style={styles.tableCell}>40+</Text>
                    <Text style={styles.tableCell}>Severe health risks</Text>
                  </View>
