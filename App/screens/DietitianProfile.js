...
function DietitianProfile({ navigation, route }) {
  ...
  const [dietitianId, setDietitianId] = useState("8");
  ...
  const UserInfo = () => {
    ...
    if (getUser) {
      ...
      fetch('https://qwikit1.pythonanywhere.com/dietitianProfile/' + dietitianId, requestOptions)
        .then((response) => response.json())
        .then((json) => {

          setDietitianData(json);
      ...
      <View style={styles.MainContainer}>
        ...
        <View style={[styles.navbar, { flexDirection: 'row' }]}>
          ...
          <View style={{ width: '50%', justifyContent: 'flex-start', alignItems: 'flex-start', left: 10 }}>
            ...
            <Text style={{ left: 10, top: 17, color: colors.black, fontSize: 14, display: lan ? 'flex' : 'none', letterSpacing: .9, fontFamily: 'Poppins_400Regular' }} >  Dietitian Profile </Text>
        ...
        <View style={[styles.body1, { justifyContent: 'flex-start', alignItems: 'center' }]}>
          ...
          <View style={[styles.body1, { justifyContent: 'flex-start', alignItems: 'center' }]}>
            ...
            <View style={{ width: '100%', justifyContent: 'center', alignItems: 'center', marginTop: 10, paddingHorizontal: 16 }}>
              <Image
                style={{ width: "100%", height: 140 }}
                resizeMode='stretch'
                source={require('../assets/fitback/dietitianProfileImg.png')}
              />

              <View style={{ width: "100%", justifyContent: "center", alignItems: "center", marginTop: -45 }}>
                <Image
                  style={{ width: 120, height: 112, borderRadius: 100, borderWidth: 1, borderColor: "silver" }}
                  resizeMode='stretch'
                  // source={require('../assets/fitback/dietitianProfileImg.png')}
                  source={dietitianData?.image ? { uri: dietitianData.image } : require('../assets/fitback/profileIconn.png')}

                />

                <Text style={{ fontFamily: 'Poppins_500Medium', fontSize: 16, color: "#242760", marginTop: 8 }}>{dietitianData?.name}</Text>
                <Text style={{ fontFamily: 'Poppins_400Regular', fontSize: 12, color: "#544C4C", marginTop: 4 }}>Nutritionist</Text>
                <View style={{ width: "100%", flexDirection: "row", justifyContent: "center", alignItems: "center" }}>
                  <Entypo style={{ marginRight: 2 }} name="location-pin" size={16} color="#544C4C" />
                  <Text style={{ fontFamily: 'Poppins_400Regular', fontSize: 12, color: "#544C4C", }}>{dietitianData?.address}</Text>
                </View>
              </View>
              ...
              <View style={{
                ...
                <View style={{
                  ...
                  {dietitianData?.experience ? <Text style={{ color: "#242760", fontSize: 16, fontFamily: 'Poppins_500Medium' }}>{dietitianData?.experience}+</Text>
                    :
                    <Text style={{ color: "#242760", fontSize: 14, fontFamily: 'Poppins_500Medium' }}>N/A</Text>
                  }
                  <Text style={{ color: "#EE416C", marginTop: 2, fontSize: 12, fontFamily: 'Poppins_400Regular' }}>years</Text>
                  <Text style={{ color: "#544C4C", marginTop: 4, fontSize: 12, fontFamily: 'Poppins_400Regular' }}>of experience</Text>
                ...
                <View style={{
                  ...
                  {dietitianData?.diet ? <Text style={{ color: "#242760", fontSize: 16, fontFamily: 'Poppins_500Medium' }}>{dietitianData?.diet}</Text>
                    :
                    <Text style={{ color: "#242760", fontSize: 14, fontFamily: 'Poppins_500Medium' }}>N/A</Text>
                  }

                  <Text style={{ color: "#EE416C", marginTop: 2, fontSize: 12, fontFamily: 'Poppins_400Regular' }}>Diet</Text>
                  <Text style={{ color: "#544C4C", marginTop: 4, fontSize: 12, fontFamily: 'Poppins_400Regular' }}>Plans Delivered</Text>
                ...
                <View style={{
                  ...
                  {dietitianData?.client ? <Text style={{ color: "#242760", fontSize: 16, fontFamily: 'Poppins_500Medium' }}>{dietitianData?.client}</Text>
                    :
                    <Text style={{ color: "#242760", fontSize: 14, fontFamily: 'Poppins_500Medium' }}>N/A</Text>
                  }

                  <Text style={{ color: "#EE416C", marginTop: 2, fontSize: 12, fontFamily: 'Poppins_400Regular' }}>Client</Text>
                  <Text style={{ color: "#544C4C", marginTop: 4, fontSize: 12, fontFamily: 'Poppins_400Regular' }}>Satisfaction</Text>
              ...
              <View style={{ width: "100%", marginTop: 20 }}>
                <Text style={{ fontFamily: 'Poppins_500Medium', fontSize: 16, color: "#242760", marginTop: 8 }}>About Me</Text>
                <Text style={{ fontFamily: 'Poppins_400Regular', fontSize: 12, color: "#242760", marginTop: 4, letterSpacing: .9 }}>{dietitianData?.about}</Text>
              </View>
