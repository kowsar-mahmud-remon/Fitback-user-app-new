...
import { Dimensions, FlatList, ActivityIndicator, StyleSheet, SafeAreaView, View, StatusBar, Pressable, Text, ScrollView, TextInput, Image, Linking, Animated, Alert } from 'react-native';
...
function WeightTracker({ navigation, route }) {
  ...
  const [graphWeight, setGraphWeight] = useState(null);
    ...
    if (getUser) {
      ...
      fetch('https://qwikit1.pythonanywhere.com/userProfile/' + userid, requestOptions)
        ...
        .then((json) => {
          ...
          const sortedByDate = json?.weight?.sort((a, b) => new Date(b.timestamp) - new Date(a.timestamp));
          const newestTen = sortedByDate.slice(0, 6).reverse();

          setGraphWeight(newestTen);

          setWeightData(json.weight);

          processWeightData(heightp);
  ...
  const monthWiseData = processWeightData(weightp);
  ...
  useEffect(() => {
    const fetchedData = [
      { value: 0, timestamp: '2024-12-17T14:37:57.305Z' },
      { value: 0, timestamp: '2024-12-25T10:29:26.534Z' },
      { value: '0', timestamp: '2024-12-25T10:30:46.001Z' },
      { value: 0, timestamp: '2024-12-25T10:31:38.811Z' },
      { value: '0', timestamp: '2024-12-25T10:32:25.803Z' },
    ];
    setGraphWeight(fetchedData);
  }, []);
  ...
  const formattedData = graphWeight.map((item) => ({
      ...
      <View style={styles.MainContainer}>
        ...
        <View style={[styles.navbar, { flexDirection: 'row' }]}>
          ...
          <View style={{ width: '50%', justifyContent: 'flex-start', alignItems: 'flex-start', left: 10 }}>
            ...
            <Text style={{ left: 10, top: 17, color: colors.black, fontSize: 14, display: lan ? 'flex' : 'none', letterSpacing: .9, fontFamily: 'Poppins_400Regular' }} >  Weight Tracker </Text>
          ...
          <ScrollView style={{ width: "100%" }} >
            ...
            <View style={{ width: '100%', justifyContent: 'center', alignItems: 'center', marginTop: 40, paddingHorizontal: 10 }}>
              ...
              <View style={styles.tableContainer}>
                <Text style={styles.tableTitle}>Your Weight History</Text>
                <View style={styles.table}>
                  <View style={styles.tableRow}>
                    <Text style={styles.tableHeading}>Month</Text>
                    <Text style={styles.tableHeading}>Date</Text>
                    <Text style={styles.tableHeading}>Your Weight</Text>
                  </View>
            ...
            <View style={{ width: '100%', justifyContent: 'center', alignItems: 'center', marginTop: 40, paddingHorizontal: 10 }}>
              ...
              <View style={styles.tableContainer}>
                <Text style={styles.tableTitle}>Ideal Weight Range by Height and Gender</Text>
                <View style={styles.table}>
                  <View style={styles.tableRow}>
                    <Text style={styles.tableHeading}>Height (cm)</Text>
                    <Text style={styles.tableHeading}>Ideal Weight (kg) - Male</Text>
                    <Text style={styles.tableHeading}>Ideal Weight (kg) - Female</Text>
                  </View>

                  <View style={styles.tableRow}>
                    <Text style={styles.tableCell}>150</Text>
                    <Text style={styles.tableCell}>50-56</Text>
                    <Text style={styles.tableCell}>45-50</Text>
                  </View>

                  <View style={styles.tableRow}>
                    <Text style={styles.tableCell}>160</Text>
                    <Text style={styles.tableCell}>55-63</Text>
                    <Text style={styles.tableCell}>50-57</Text>
                  </View>

                  <View style={styles.tableRow}>
                    <Text style={styles.tableCell}>170</Text>
                    <Text style={styles.tableCell}>63-72</Text>
                    <Text style={styles.tableCell}>57-66</Text>
                  </View>


                  <View style={styles.tableRow}>
                    <Text style={styles.tableCell}>180</Text>
                    <Text style={styles.tableCell}>72-81</Text>
                    <Text style={styles.tableCell}>66-75</Text>
                  </View>


                  <View style={styles.tableRow}>
                    <Text style={styles.tableCell}>190</Text>
                    <Text style={styles.tableCell}>81-92</Text>
                    <Text style={styles.tableCell}>75-85</Text>
                  </View>

                  <View style={styles.tableRow}>
                    <Text style={styles.tableCell}>200</Text>
                    <Text style={styles.tableCell}>92-37</Text>
                    <Text style={styles.tableCell}>85-90</Text>
                  </View>
            ...
            <View style={{ width: '100%', justifyContent: 'center', alignItems: 'center', marginTop: 40, marginBottom: 20, paddingHorizontal: 10 }}>
              ...
              {/* Optional: Latest Entry */}
              {/* <View style={{ marginTop: 20, marginBottom: 20 }}>
                <Text style={{ fontSize: 16 }}>
                  Latest Weight: {formattedData.slice(-1)[0]?.value} kg
                </Text>
                <Text style={{ fontSize: 16 }}>
                  On: {formattedData.slice(-1)[0]?.date}
                </Text>
              </View> */}
            </View>
