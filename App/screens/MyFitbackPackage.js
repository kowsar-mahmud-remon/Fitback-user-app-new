...
function MyFitBackPackage({ navigation, route }) {
      ...
      <View style={styles.MainContainer}>
        ...
        <View style={[styles.navbar, { flexDirection: 'row' }]}>
          ...
          <View style={{ width: '50%', justifyContent: 'flex-start', alignItems: 'flex-start', left: 10 }}>
            ...
            <Text style={{ left: 10, top: 17, color: colors.black, fontSize: 14, display: lan ? 'flex' : 'none', letterSpacing: .9, fontFamily: 'Poppins_400Regular' }} >  My FitBack Package </Text>
        ...
        <View style={[styles.body1, { justifyContent: 'flex-start', alignItems: 'center' }]}>
          ...
          <View style={{ width: '100%', justifyContent: 'center', alignItems: 'center', marginTop: 40 }}>
            <View style={{ marginBottom: 5, bottom: 15, width: '100%', justifyContent: 'space-evenly', alignItems: 'center', flexDirection: 'row', left: 0 }}>
              ...
              <Pressable style={{ marginLeft: 0, flexDirection: 'row', borderRadius: 4, width: '28%', height: 28, backgroundColor: personal ? "#EE416C" : colors.white, justifyContent: 'center', alignItems: 'center' }} onPress={() => { pressPersonal(); }}>
                ...
                <Text style={{ fontSize: 12, color: personal ? colors.white : "#EE416C", left: 5, fontFamily: 'Poppins_400Regular', letterSpacing: .9 }}>All</Text>
              ...
              <Pressable style={{ marginLeft: 0, flexDirection: 'row', borderRadius: 4, width: '32%', height: 28, backgroundColor: medical ? "#EE416C" : colors.white, justifyContent: 'center', alignItems: 'center' }} onPress={() => { pressMedical(); }}>
                ...
                <Text style={{ fontSize: 12, color: medical ? colors.white : "#EE416C", left: 5, fontFamily: 'Poppins_400Regular', letterSpacing: .9 }}>Active</Text>
              ...
              <Pressable style={{ marginLeft: 0, flexDirection: 'row', borderRadius: 4, width: '28%', height: 28, backgroundColor: lifestyle ? "#EE416C" : colors.white, justifyContent: 'center', alignItems: 'center' }} onPress={() => { pressLifestyle(); }}>
                ...
                <Text style={{ fontSize: 12, color: lifestyle ? colors.white : "#EE416C", left: 5, fontFamily: 'Poppins_400Regular', letterSpacing: .9 }}>Expired</Text>
            ...
            <View style={{ width: '100%', justifyContent: 'flex-start', alignItems: 'flex-start', display: personal ? 'flex' : 'none', paddingHorizontal: 16 }}>
              <Text>All</Text>
            </View>
            <View style={{ width: '100%', justifyContent: 'flex-start', alignItems: 'flex-start', display: medical ? 'flex' : 'none', paddingHorizontal: 16 }}>
              <Text>Active</Text>
            </View>
            <View style={{ width: '100%', justifyContent: 'flex-start', alignItems: 'flex-start', display: lifestyle ? 'flex' : 'none', paddingHorizontal: 16 }}>
              <Text>Expired</Text>
            </View>
...
export default MyFitBackPackage;