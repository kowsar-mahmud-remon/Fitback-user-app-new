...
function BellySizeTracker({ navigation, route }) {
  ...
  const processBellySizeData = (data) => {
  ...
  const monthWiseData = processBellySizeData(bellySize);
      ...
      <View style={styles.MainContainer}>
        ...
        <View style={[styles.navbar, { flexDirection: 'row' }]}>
          ...
          <View style={{ width: '50%', justifyContent: 'flex-start', alignItems: 'flex-start', left: 10 }}>
            ...
            <Text style={{ left: 10, top: 17, color: colors.black, fontSize: 14, display: lan ? 'flex' : 'none', letterSpacing: .9, fontFamily: 'Poppins_400Regular' }} >  Belly Size Tracker </Text>
          ...
          <ScrollView style={{ width: "100%" }} >
            ...
            <View style={{ width: '100%', justifyContent: 'center', alignItems: 'center', marginTop: 40, paddingHorizontal: 10 }}>
              ...
              <View style={styles.tableContainer}>
                <Text style={styles.tableTitle}>Your Belly Size History</Text>
                <View style={styles.table}>
                  <View style={styles.tableRow}>
                    <Text style={styles.tableHeading}>Month</Text>
                    <Text style={styles.tableHeading}>Date</Text>
                    <Text style={styles.tableHeading}>Your Belly Size</Text>
                  </View>
            ...
            <View style={{ width: '100%', justifyContent: 'center', alignItems: 'center', marginTop: 40, paddingHorizontal: 10 }}>
              ...
              <View style={styles.tableContainer}>
                <Text style={styles.tableTitle}>Healthy Waist Size Guidelines by Gender</Text>
                <View style={styles.table}>
                  <View style={styles.tableRow}>
                    <Text style={styles.tableHeading}>Gender</Text>
                    <Text style={styles.tableHeading}>Waist Size (cm)</Text>
                    <Text style={styles.tableHeading}>Health Risk Classification</Text>
                  ...
                  <View style={styles.tableRow}>
                    ...
                    <Text style={styles.tableCell}>Low Risk</Text>
                    <Text style={styles.tableCell}>Low risk of heart and metabolic issues.</Text>
                  </View>

                  <View style={styles.tableRow}>
                    <Text style={styles.tableCell}>Male</Text>
                    <Text style={styles.tableCell}>94 - 101.9</Text>
                    <Text style={styles.tableCell}>Moderate Risk</Text>
                    <Text style={styles.tableCell}>Moderate health risk; caution advised.</Text>
                  </View>

                  <View style={styles.tableRow}>
                    <Text style={styles.tableCell}>Male</Text>
                    <Text style={styles.tableCell}>{"≥ 102"}</Text>
                    <Text style={styles.tableCell}>High Risk</Text>
                    <Text style={styles.tableCell}>High risk; seek medical advice.</Text>
                  </View>
                  ...
                  <View style={styles.tableRow}>
                    ...
                    <Text style={styles.tableCell}>Low Risk</Text>
                    <Text style={styles.tableCell}>Low risk of health issues.</Text>
                  </View>

                  <View style={styles.tableRow}>
                    <Text style={styles.tableCell}>Female</Text>
                    <Text style={styles.tableCell}>80 - 87.9</Text>
                    <Text style={styles.tableCell}>Moderate Risk</Text>
                    <Text style={styles.tableCell}>Moderate risk; consider lifestyle changes.</Text>
                  </View>

                  <View style={styles.tableRow}>
                    <Text style={styles.tableCell}>Female</Text>
                    <Text style={styles.tableCell}>{"≥ 88"}</Text>
                    <Text style={styles.tableCell}>High Risk</Text>
                    <Text style={styles.tableCell}>High risk; consult healthcare provider.</Text>
                  </View>
...
export default BellySizeTracker;