            ...
            <View style={styles.MainContainer}>
                ...
                <View style={[styles.navbar, { flexDirection: 'row' }]}>
                    ...
                    <View style={{ width: '50%', justifyContent: 'flex-start', alignItems: 'flex-start', left: 10 }}>
                        ...
                        <Text style={{ left: 10, top: 17, color: colors.black, fontSize: 14, display: lan ? 'flex' : 'none', letterSpacing: .9, fontFamily: 'Poppins_400Regular' }} >  Services </Text>
                ...
                <View style={[styles.body1, { justifyContent: 'flex-start', alignItems: 'center' }]}>
                        ...
                        <View style={{ width: '100%', flexDirection: 'row', justifyContent: 'space-evenly' }}>
                            <Pressable style={{ width: '27%', height: 150, borderRadius: 16, justifyContent: 'center', alignItems: 'center' }} onPress={() => navigation.navigate("Pharmacy", { reminder: true })}>
                                <View style={{ width: '100%', height: 120, backgroundColor: colors.white, borderColor: colors.ash1, borderRadius: 30, borderWidth: 1, justifyContent: 'center', alignItems: 'center', borderWidth: 1 }}>
                                    {/* <Doctor width={50} height={70}/> */}
                                    <Image
                                        style={{ width: 50, height: 70 }}
                                        resizeMode='contain'
                                        source={require('../assets/services_online_pharmacy.jpg')}
                                    />
                                </View>
                                <Text style={{ width: '120%', top: 7, color: colors.ash, fontSize: 12, fontFamily: 'Poppins_400Regular', letterSpacing: 0.9 }}>Online Pharmacy</Text>

                            </Pressable>


                            <Pressable style={{ width: '27%', height: 150, borderRadius: 16, justifyContent: 'center', alignItems: 'center' }} onPress={() => navigation.navigate("MakeAppoinment", {
                                ...
                                <View style={{ width: '100%', height: 120, backgroundColor: colors.white, borderColor: colors.ash1, borderRadius: 30, borderWidth: 1, justifyContent: 'center', alignItems: 'center', borderWidth: 1 }}>
                                    ...
                                    <Image
                                        style={{ width: 50, height: 70 }}
                                        resizeMode='contain'
                                        source={require('../assets/services_online_doctor.jpg')}
                                    />
                                </View>
                                <Text style={{ top: 7, color: colors.ash, fontSize: 12, fontFamily: 'Poppins_400Regular', letterSpacing: 0.9 }}>Online Doctor</Text>

                            </Pressable>

                            <Pressable style={{ width: '27%', height: 150, borderRadius: 16, justifyContent: 'center', alignItems: 'center' }} onPress={() => navigation.navigate("AmbulanceRequest", {
                                namep: namep, phonep: phonep, emailp: emailp, areap: areap, postcodep: postcodep, streetNop: streetNop, nicknamep: nicknamep,
                                bloodgroupp: bloodgroupp, genderp: genderp, agep: agep, heightp: heightp, weightp: weightp, bloodpressurep: bloodpressurep,
                                altphonenumberp: altphonenumberp, emgphonenumberp: emgphonenumberp, dateofbathp: dateofbathp, occupationp: occupationp,
                                allergiesp: allergiesp, injuriesp: injuriesp, surgeriesp: surgeriesp, diabetesp: diabetesp, smokingp: smokingp, alcoholp: alcoholp, walkingp: walkingp, junkp: junkp, gymp: gymp, nofi: false
                                ...
                                <View style={{ width: '100%', height: 120, backgroundColor: colors.white, borderColor: colors.ash1, borderRadius: 30, borderWidth: 1, justifyContent: 'center', alignItems: 'center' }}  >
                                    {/* <Ambulance width={50} height={70}/> */}
                                    <Image
                                        style={{ width: 70, height: 70 }}
                                        resizeMode='contain'
                                        source={require('../assets/services_ambulance.jpg')}
                                    />
                                </View>
                                <Text style={{ top: 7, color: colors.ash, fontSize: 12, fontFamily: 'Poppins_400Regular', letterSpacing: 0.9 }}>Ambulance</Text>
                                {/* <Text style={{top:7,color:colors.red,fontSize:10,fontFamily: 'Poppins_400Regular',letterSpacing:0.5}}>(Coming Soon)</Text> */}
                    ...
                    <View style={{ width: '100%', justifyContent: 'center', alignItems: 'center', marginTop: 20 }}>
                        ...
                        <View style={{ width: '100%', flexDirection: 'row', justifyContent: 'flex-start' }}>
                            {/* <Pressable style={{left:'13%',width:'27%' , height:150,borderRadius:16,justifyContent:'center',alignItems:'center'}} onPress={() =>  navigation.navigate("BloodDonation",{})}> */}
                            <Pressable style={{ left: 20, width: '27%', height: 150, borderRadius: 16, justifyContent: 'center', alignItems: 'center' }} onPress={() => navigation.navigate("BloodDonation", {})}>
                                ...
                                <View style={{ width: '100%', height: 120, backgroundColor: colors.white, borderColor: colors.ash1, borderRadius: 30, borderWidth: 1, justifyContent: 'center', alignItems: 'center' }}>
                                    ...
                                    <Image
                                        style={{ width: 50, height: 70 }}
                                        resizeMode='contain'
                                        source={require('../assets/services_blood_donation.jpg')}
                                    />
                                </View>
                                <Text style={{ width: '110%', top: 7, color: colors.ash, fontSize: 12, fontFamily: 'Poppins_400Regular', letterSpacing: 0.9 }}>Blood Donation</Text>
                            ...
                            {/* <Pressable style={{width:'27%' , height:150,borderRadius:16,justifyContent:'center',alignItems:'center'}}  onPress={() => navigation.navigate("Myappointment",{})}>
                                <View style={{width:'100%' , height:120, backgroundColor:colors.white,borderColor:colors.ash1,borderRadius:30,borderWidth:1,justifyContent:'center',alignItems:'center'}}>
                                    ...
                                    <Image
                                     style={{ width: 50, height: 70}}
                                     resizeMode='contain'
                                     source={require('../assets/callicon.jpg')}
                                    />
                                </View>
                                <Text style={{top:7,color:colors.ash,fontSize:12,fontFamily: 'Poppins_400Regular',letterSpacing:0.9}}>Appoinments</Text>

                            </Pressable> */}


                            {/* <Pressable style={{top:4,left:'26%',width:'27%' , height:160,borderRadius:16,justifyContent:'center',alignItems:'center'}} > */}
                            <Pressable style={{ left: 40, top: 4, width: '27%', height: 160, borderRadius: 16, justifyContent: 'center', alignItems: 'center' }} >
                                <View style={{ width: '100%', height: 120, backgroundColor: colors.white1, borderColor: colors.ash1, borderRadius: 30, borderWidth: 1, justifyContent: 'center', alignItems: 'center' }}>

                                    <Image
                                        style={{ width: 60, height: 70 }}
                                        resizeMode='contain'
                                        source={require('../assets/services_lab_test.jpg')}
                                    />
                                </View>
                                <Text style={{ top: 7, color: colors.ash2, fontSize: 12, fontFamily: 'Poppins_400Regular', letterSpacing: 0.9 }}>Lab Test</Text>
                                <Text style={{ top: 7, color: colors.red, fontSize: 10, fontFamily: 'Poppins_400Regular', letterSpacing: 0.5 }}>(Coming Soon)</Text>
