...
function CustomerReview({ navigation, route }) {
      ...
      <View style={styles.MainContainer}>
        ...
        <View style={[styles.navbar, { flexDirection: 'row' }]}>
          ...
          <View style={{ width: '50%', justifyContent: 'flex-start', alignItems: 'flex-start', left: 10 }}>
            ...
            <Text style={{ left: 10, top: 17, color: colors.black, fontSize: 14, display: lan ? 'flex' : 'none', letterSpacing: .9, fontFamily: 'Poppins_400Regular' }} >  Customer Review </Text>
          ...
          <ScrollView >
            ...
            <View style={{ width: '100%', justifyContent: 'center', alignItems: 'center', marginTop: 40, paddingHorizontal: 16 }}>
              ...
              <View style={{ width: "100%", flexDirection: "row", justifyContent: "space-between", marginBottom: 30 }}>
                <Text style={{ fontFamily: 'Poppins_700Bold', fontSize: 14 }}>Review ({getAllReview?.length})</Text>

                <View style={{ flexDirection: "row", alignItems: "center" }}>
                  <FontAwesome style={{ marginBottom: 3 }} name="star" size={18} color="gold" />
                  <Text style={{ fontFamily: 'Poppins_700Bold', fontSize: 14, marginLeft: 2 }}> {avgRating}</Text>
                </View>

              </View>

              {
                getAllReview?.map((data, index) => <View key={index} style={{ width: "100%", flexDirection: "row", justifyContent: "space-between", flexDirection: "row", marginBottom: 20 }}>
                  <View style={{ width: "20%" }}>
                    <Image
                      style={{
                        borderRadius: 100,
                  ...
                  <View style={{ width: "80%", }}>
                    ...
                    <View style={{ flexDirection: "row", alignItems: "center", flexWrap: "wrap", marginTop: 4 }}>
                      {Array.from({ length: 5 }, (_, i) => (
                        <FontAwesome
                          ...
                          name="star"
                          size={20}
                          color={i < Math.min(data?.rating || 0, 5) ? "gold" : "#c0c0c0"} // Show filled stars up to the rating, else gray
                          style={{ marginRight: 2 }}
                        />
                      ))}
                    ...
                    <Text style={{ fontFamily: 'Poppins_400Regular', fontSize: 12, marginTop: 4 }}>{data?.review_text}</Text>
