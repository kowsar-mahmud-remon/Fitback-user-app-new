...
function HealthTipsVideo({ navigation, route }) {
      ...
      <View style={styles.MainContainer}>
        ...
        <View style={[styles.navbar, { flexDirection: 'row' }]}>
          ...
          <View style={{ width: '50%', justifyContent: 'flex-start', alignItems: 'flex-start', left: 10 }}>
            ...
            <Text style={{ left: 10, top: 17, color: colors.black, fontSize: 14, display: lan ? 'flex' : 'none', letterSpacing: .9, fontFamily: 'Poppins_400Regular' }} >  Health Tips Video </Text>
              ...
              {getAllExerciseVideo?.map((data, index) => {
                ...
                return (
                  ...
                  >
                    ...
                    <View style={{ width: "100%", paddingHorizontal: 4, paddingBottom: 12, top: 10 }}>
                      <Text style={{ fontSize: 12, fontFamily: 'Poppins_400Regular', letterSpacing: 0.9, textAlign: "left", marginTop: 6, paddingHorizontal: 8 }}>
                        ...
                        {data.healthtips_name
                          ? data.healthtips_name.length > 60
                            ? data.healthtips_name.slice(0, 60) + "..."
                            : data.healthtips_name
                          : ""}
