...
function Health({ navigation, route }) {
  ...
  const [healthTrackerData, setHealthTrackerData] = useState();
    ...
    if (getUser) {
      ...
      fetch('https://qwikit1.pythonanywhere.com/userProfile/' + userid, requestOptions)
        ...
        .then((json) => {
          ...
          const bmi = json.bmicalculate.sort((a, b) => new Date(b.timestamp) - new Date(a.timestamp));
          const calorie = json.caloridata.sort((a, b) => new Date(b.timestamp) - new Date(a.timestamp));
          // const health = json.sort((a, b) => new Date(b.timestamp) - new Date(a.timestamp));

          setBmiData(bmi);
          setCalorieData(calorie);
          // setHealthTrackerData(health)
      ...
      <View style={styles.MainContainer}>
        ...
        <View style={[styles.navbar, { flexDirection: 'row' }]}>
          ...
          <View style={{ width: '50%', justifyContent: 'flex-start', alignItems: 'flex-start', left: 10 }}>
            ...
            <Text style={{ left: 10, top: 17, color: colors.black, fontSize: 14, display: lan ? 'flex' : 'none', letterSpacing: .9, fontFamily: 'Poppins_400Regular' }} >  Health </Text>
        ...
        <View style={[styles.body1, { justifyContent: 'flex-start', alignItems: 'center' }]}>
          ...
          <View style={{ width: '100%', justifyContent: 'center', alignItems: 'center', marginTop: 40 }}>
            ...
            <View style={{ width: '100%', flexDirection: 'row', justifyContent: 'space-evenly' }}>
              <Pressable style={{ width: '45%', height: 150, borderRadius: 16, justifyContent: 'center', alignItems: 'center', backgroundColor: "#f6a5b9" }} onPress={() => navigation.navigate("BmiCalculator", { reminder: true })}>

                <View style={{ width: '100%' }}>
                  <Text style={{ top: 16, left: 12, color: colors.ash, fontSize: 24, fontFamily: 'Poppins_700Bold', letterSpacing: 0.9, color: "white" }}>26.00</Text>
                  <Text style={{ width: '120%', top: 7, left: 12, color: colors.ash, fontSize: 14, fontFamily: 'Poppins_400Regular', letterSpacing: 0.9, color: "white" }}>Body Mass</Text>
                  <Text style={{ width: '120%', top: 7, left: 12, color: colors.ash, fontSize: 14, fontFamily: 'Poppins_400Regular', letterSpacing: 0.9, color: "white" }}>Index</Text>
                </View>
                <View style={{ width: '100%', justifyContent: 'center', alignItems: 'flex-end', right: 12, bottom: 12 }}>
                  <Image
                    style={{ width: 70, height: 70 }}
                    resizeMode='contain'
                    source={require('../assets/fitback/bmiIcon.png')}
                  />
                </View>
              ...
              <Pressable style={{ width: '45%', height: 150, borderRadius: 16, justifyContent: 'center', alignItems: 'center', backgroundColor: "#f6a5b9" }} onPress={() => navigation.navigate("CalorieCalculator", { reminder: true })}>

                <View style={{ width: '100%' }}>
                  <View style={{ width: '100%', flexDirection: "row", top: 16, left: 12, right: 10 }}>
                    <Text style={{ color: colors.ash, fontSize: 24, fontFamily: 'Poppins_700Bold', letterSpacing: 0.9, color: "white" }}>2540</Text>
                    <Text style={{ width: '120%', color: colors.ash, fontSize: 10, top: 16, fontFamily: 'Poppins_400Regular', letterSpacing: 0.9, color: "white", left: 4 }}>Calories/day</Text>
                  </View>
                  <Text style={{ width: '120%', top: 7, left: 12, color: colors.ash, fontSize: 14, fontFamily: 'Poppins_400Regular', letterSpacing: 0.9, color: "white" }}>Calorie</Text>
                  <Text style={{ width: '120%', top: 7, left: 12, color: colors.ash, fontSize: 14, fontFamily: 'Poppins_400Regular', letterSpacing: 0.9, color: "white" }}>Counter</Text>
                </View>
                <View style={{ width: '100%', justifyContent: 'center', alignItems: 'flex-end', right: 12, bottom: 12 }}>
                  <Image
                    style={{ width: 65, height: 65 }}
                    resizeMode='contain'
                    source={require('../assets/fitback/CaloriesIcon.png')}
                  />
                </View>
          ...
          <View style={{ width: '100%', justifyContent: 'center', alignItems: 'center', marginTop: 20 }}>
            ...
            <View style={{ width: '100%', flexDirection: 'row', left: 13 }}>
              <Pressable style={{ width: '45%', height: 150, borderRadius: 16, justifyContent: 'center', alignItems: 'center', backgroundColor: "#f6a5b9" }} onPress={() => navigation.navigate("HealthTracking", { reminder: true })}>

                <View style={{ width: '100%' }}>

                  <View style={{ width: '100%', flexDirection: "row", top: 16, left: 12, right: 10 }}>
                    <Text style={{ color: colors.ash, fontSize: 24, fontFamily: 'Poppins_700Bold', letterSpacing: 0.9, color: "white" }}>26.00</Text>
                    <Text style={{ width: '120%', color: colors.ash, fontSize: 10, top: 14, fontFamily: 'Poppins_400Regular', letterSpacing: 0.9, color: "white", left: 6 }}>%</Text>
                  </View>

                  <Text style={{ width: '120%', top: 7, left: 12, color: colors.ash, fontSize: 14, fontFamily: 'Poppins_400Regular', letterSpacing: 0.9, color: "white" }}>Health</Text>
                  <Text style={{ width: '120%', top: 7, left: 12, color: colors.ash, fontSize: 14, fontFamily: 'Poppins_400Regular', letterSpacing: 0.9, color: "white" }}>Tracker</Text>
                </View>
                <View style={{ width: '100%', justifyContent: 'center', alignItems: 'flex-end', right: 12, bottom: 12 }}>
                  <Image
                    style={{ width: 70, height: 70 }}
                    resizeMode='contain'
                    source={require('../assets/fitback/healthTrackerIcon.png')}
                  />
                </View>
